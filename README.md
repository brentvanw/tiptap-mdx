...
This is the property both prior tools failed. It is enforced by an automated test suite — 163 tests, including every `.mdx` file in a real-world validation corpus.
